	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Cadastro de <b>curriculos</b></h2>
						Sistema de cadastro e busca de vagas (by Henrique Lobato)
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar curriculo (candidato)</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
	            	...
	            	try{
		                ...
		                ArrayList<Curriculo> lista = dao.buscarTodos();
		                for(int i = 0; i < lista.size(); i++){
		                	out.print("<tr>");
		                	out.print("<td>");
		                	out.print("<span class='custom-checkbox'>");
		                	out.print("<input type='checkbox' id='checkbox1' name='options[]' value='1'>");
		                	out.print("<label for='checkbox1'></label>");
		                	out.print("</span>");
		                	out.print("</td>");
		                	out.print("<td>" + lista.get(i).getNome() + "</td>");
		                	out.print("<td>" + lista.get(i).getEmail() + "</td>");
		                	out.print("<td>" + lista.get(i).getTelefone() + "</td>");
		                	out.print("<td>" + lista.get(i).getLinguagens() + "</td>");
		...
		<div class="modal-content">
			<form action="exec_inserir_curriculo.jsp" method="POST">
				<div class="modal-header">						
					<h4 class="modal-title">Adicionar currículo (candidato)</h4>
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input name="dataNascimento" class="form-control" required></input>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input name="linkGithub" type="text" class="form-control" required>
					</div>
