    ...
    <body>
        <script>
            function conf(id){
                ...
                if(resp){
                    window.location.href="exec_excluir.jsp?id=" + id;
                }
            }
        </script>
        <table class="table">
            ...
            <%
                ...
                for(int i = 0; i < lista.size(); i++){
                    ...
                    out.print("</td><td>");
                    out.print(lista.get(i).getDiferenciais());
                    out.print("</td><td>");
                    out.print(lista.get(i).getLinguagens());
                    out.print("</td><td>");
                    out.print(lista.get(i).getLinkGit());
                    out.print("</td><td>");
                    out.print(lista.get(i).getExperiencia());
                    
                    out.print("</td><td><a href='alterar_curriculo.jsp?");
                    out.print("id="+lista.get(i).getId());
                    out.print("&nome="+lista.get(i).getNome());
                    out.print("&idade="+lista.get(i).getNome());
                    out.print("&telefone="+lista.get(i).getTelefone());
                    out.print("'>Alterar</a>");
                    out.print("</td><td><a href='javascript:func()' ");
                    out.print("onclick='conf("+lista.get(i).getId()+")'>Excluir</a>");
                    out.print("</td></tr>");
                }
            	}catch(Exception e){
